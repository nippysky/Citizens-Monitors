...
const ResultAndCollation = (props:any) => (
  <Svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    <Rect width={24} height={24} fill="url(#pattern0_228_13697)" />
    <Defs>
      <Pattern
        id="pattern0_228_13697"
        patternContentUnits="objectBoundingBox"
        width={1}
        height={1}
      >
        <Use xlinkHref="#image0_228_13697" transform="scale(0.0078125)" />
      </Pattern>
      <Image
        id="image0_228_13697"
        width={128}
...
export default ResultAndCollation;
