...
export default function CollationOverviewTab({
  collation,
    ...
    >
        ...
        {!hasNoData ? (
          <View style={styles.partyList}>
            {collation.parties.map((p) => (
              <PartyResultRow key={p.id} party={p} />
            ))}
          </View>
        ) : (
          <EmptyInlineBlock
            title="No Election Report yet"
            subtitle="No election report has been submitted for this election yet."
          />
        )}
      </View>
      ...
      <View style={styles.section}>
        ...
        <AppText style={styles.sectionSubtitle}>
          See the aggregate voters reports from {collation.coveredUnits} polling
          units in {collation.location} reported by our observer.
        </AppText>
        ...
        {!hasNoData ? (
          ...
          <EmptyInlineBlock
            title="No Election Report yet"
            subtitle="Citizen Monitor have not commenced operation yet."
          />
        )}
...
function LowerTabButton({
  ...
  return (
    <Pressable
      onPress={onPress}
      style={[styles.lowerTabButton, active && styles.lowerTabButtonActive]}
    >
      <AppText style={[styles.lowerTabText, active && styles.lowerTabTextActive]}>
        {title}
      </AppText>
    </Pressable>
  );
